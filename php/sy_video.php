        ...
        <div style="background: #1094fa; width: 97%; padding-left: 5px;" align="left">
            ...
            <a href="javascript:void(0)" onclick="window.location.href='https://nelsonwp.github.io/blog/php/video_list.php?lm=1&name=前端'"><span class="btn btn-info" style="color: #FFFFFF;margin-bottom: 10px; margin-left: 80%;">&nbsp;查看更多>></span></a>
        </div>
	    ...
	    $dbname="db_blogwp";
            ...
            try {
                ...
                while($row=$result->fetch()){//操作数据
                    ...
                    echo "<a href='https://nelsonwp.github.io/blog/php/video_play.php?wjm=".$row['wj_name']."'><img src='".$row['url']."' style='width: 100%; height: 100%; object-fit: cover;' alt='".$row['wj_name']."'/></a>";
                    echo "</li>";
